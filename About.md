...
**Microsoft Infrastructure Specialist | Automation & Operations Focus**
...
- **K-12 Technology Context:** Identity lifecycle operations, FERPA/CIPA controls, SIS integration workflows
...
- Supported high-stakes legal operations requiring rapid, reliable infrastructure setup
- Built secure server/VPN/file workflows for temporary and extended trial operations
- Implemented backup/recovery controls for sensitive evidence and legal data handling
- Trained legal teams on presentation systems and secure document workflows

**Technologies:** Windows Server 2008-2012, Exchange Server, SQL Server, backup/DR tooling
...
- **MCSA (Legacy):** Windows Server 2012 (retired track)
...
- **GitHub:** [github.com/FlyguyTestRun/ISD-Showcase](https://github.com/FlyguyTestRun/ISD-Showcase)
